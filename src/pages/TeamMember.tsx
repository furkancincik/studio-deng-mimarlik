          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="aspect-[3/4] bg-secondary flex items-center justify-center">
                <span className="text-muted-foreground text-sm font-sans">Photo placeholder</span>
              </div>
              ...
              <div className="lg:col-span-2 space-y-8">
                <div>
                  ...
                  <p className="text-lg text-muted-foreground font-sans mt-2">{member.title || "Title"}</p>
                  <p className="text-sm text-muted-foreground font-sans mt-1">{member.expertise || "Area of expertise"}</p>
                </div>

                <div className="border-t border-border pt-8">
                  <h3 className="text-xs tracking-[0.3em] uppercase text-muted-foreground font-sans mb-4">Biography</h3>
                ...
                <div className="border-t border-border pt-8">
                  <h3 className="text-xs tracking-[0.3em] uppercase text-muted-foreground font-sans mb-4">Social</h3>
                ...
                {/* Related Projects */}
                <div className="border-t border-border pt-8">
                  <h3 className="text-xs tracking-[0.3em] uppercase text-muted-foreground font-sans mb-6">Related Projects</h3>
