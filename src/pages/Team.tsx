      ...
      <section className="relative h-[50vh] md:h-[60vh] bg-primary flex items-end overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 pb-16 md:pb-24">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <span className="text-[11px] tracking-[0.35em] uppercase text-terracotta-light font-display block mb-4">Ekibimiz</span>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-medium text-primary-foreground leading-[1.05]">
              Takımımız
            </h1>
            <p className="text-primary-foreground/50 max-w-xl text-lg font-sans mt-4">
              Farklı disiplinlerden gelen deneyimli mimarlar ve tasarımcılardan oluşan tutkulu ekibimizle tanışın.
            </p>
          </motion.div>
        </div>
      </section>
