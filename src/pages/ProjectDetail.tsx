                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12">
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="aspect-[4/3] bg-secondary flex items-center justify-center">
                      <span className="text-muted-foreground text-sm font-sans">Görsel {i + 1}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                {project.isOngoing && (
                  <div className="bg-secondary p-6 space-y-3">
                    <p className="text-xs tracking-[0.2em] uppercase text-muted-foreground font-sans">İlerleme</p>
