      ...
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-6 md:px-12">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <SectionHeading label="Journal" title="Blog" subtitle="Content will be added here" />
          </motion.div>
            ...
            {placeholderBlogPosts.map((post, i) => (
              ...
              >
                <Link to={`/blog/${post.id}`} className="group block">
                  ...
                  <p className="text-xs text-muted-foreground font-sans mb-2">{post.date || "Date"}</p>
                  ...
                  <p className="text-sm text-muted-foreground font-sans mt-2">
                    {post.excerpt || "Content will be added here"}
                  </p>
                </Link>
              </motion.div>
            ))}
